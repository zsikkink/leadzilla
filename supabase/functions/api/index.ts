...
function openAiDraftDeveloperPrompt(input: {
  ...
  return [
    ...
    "Treat ICP descriptions, hooks, angles, and messaging guidance as private strategy. Never quote, paraphrase, or expose that strategy in the message.",
    ...
    "Open with one concise, verified observation about the specific business. Never open with a generic market thesis, ICP strategy, or an assumption about the prospect's pain.",
    ...
    'For email, write a natural, specific 2-6 word buyer-readable question tied to the observed business context. Avoid formulaic subjects beginning with "Simpler", "Easier", "Faster", "Cleaner", "Tighter", "More", or "Streamline". Never use the words workflow, platform, solution, demo, or Leadzilla in the subject. For SMS-style direct messages, subject must be null.',
