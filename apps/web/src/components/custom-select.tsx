...
export function CustomSelect({
  ...
  return (
    <div ref={ref} className={cn('relative', className)}>
      ...
      <div
        className={cn(
          'absolute top-full z-50 mt-1.5 min-w-[180px] max-w-[min(320px,calc(100vw-2rem))] overflow-hidden rounded-xl border border-border/50 bg-card shadow-xl shadow-black/20',
