...
export function parseBusinessDataForCard(raw: Record<string, unknown>): AboutBusinessCardProps {
  const websiteScrape = raw.apify_website_scrape_json as Record<string, unknown> | null ?? null;
  const instagramScrape = raw.apify_instagram_scrape_json as Record<string, unknown> | null ?? null;
  const instagramHandle = typeof raw.instagram_handle === 'string' ? raw.instagram_handle : null;
  ...
  return {
    ...
    websiteDomain: typeof raw.website_domain === 'string' ? raw.website_domain : null,
    phoneE164: typeof raw.phone_e164 === 'string' ? raw.phone_e164 : null,
    hasWhatsapp: typeof raw.has_whatsapp === 'boolean' ? raw.has_whatsapp : null,
    hasInstagram: typeof raw.has_instagram === 'boolean' ? raw.has_instagram : null,
    acceptsOnlinePayments: typeof raw.accepts_online_payments === 'boolean' ? raw.accepts_online_payments : null,
    followerCount: typeof raw.follower_count === 'number' ? raw.follower_count : null,
    recentActivity: typeof raw.recent_activity === 'boolean' ? raw.recent_activity : null,
    physicalAddressPresent: typeof raw.physical_address_present === 'boolean' ? raw.physical_address_present : null,
    socialLinks,
    techStack,
    certifications,
    contactEmails,
